...
class HRmEmployee(models.Model):
    ...
    confirmation_date = models.DateTimeField(default=now)
...
class OrderEntryInfo(models.Model):
    ...
    region_name = models.ForeignKey(LibRegion, related_name='lib_region_name', on_delete=models.CASCADE, null=True)
    agent_name = models.ForeignKey(LibAgent, related_name='lib_agent_name', on_delete=models.CASCADE, null=True)
    client_name = models.ForeignKey(LibClient, related_name='lib_client_name', on_delete=models.CASCADE, null=True)
    quality_label = models.CharField(max_length=30, choices=STATUS, default=1)
    unit_name = models.ForeignKey(LibUnit, related_name='lib_unit_name', on_delete=models.CASCADE, null=True)
    ...
    emp_code = models.ForeignKey(HRmEmployee, related_name='lin_emp_code', on_delete=models.CASCADE, null=True)
    ...
    currency_code = models.ForeignKey(LibCurrency, related_name='lib_currency_code', on_delete=models.CASCADE, null=True)
...
class OmPoCostDetail(models.Model):
    ...
    product_name_short = models.ForeignKey(InvProductInfo, related_name='inv_product_name', on_delete=models.CASCADE)
...
class WoPOCountryDetails(models.Model):
    ...
    country_code = models.ForeignKey(LibCountry, related_name='lib_country_code', on_delete=models.CASCADE)
    code = models.CharField(max_length=50, null=False)
    product_code = models.ForeignKey(InvProductInfo, related_name='inv_product_code', on_delete=models.CASCADE)
...
class OmPoDetailsMaster(models.Model):
    ...
    po_number = models.ForeignKey(OmPoBreakDown, on_delete=models.CASCADE, related_name='copy_po_number', null=True)
    job_no = models.ForeignKey(WoPOCountryDetails, on_delete=models.CASCADE, related_name='po_job_no', blank=True, null=True)
...
class OmPoLabdipInfo(models.Model):
    ...
    po_no_mst_id = models.CharField(max_length=50, null=False)
    po_number_mst = models.CharField(max_length=50, null=False)
    color_name = models.ForeignKey(LibColor, related_name='libdip_color_name', on_delete=models.CASCADE)
